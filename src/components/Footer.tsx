      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://leetcode.com/u/AnishaRay/" target="_blank" rel="noopener noreferrer"
                className="hover:text-blue-400 transition">
                <Code2 className="h-6 w-6" />
              </a>
              <a href="https://github.com/anisha20ray" target="_blank" rel="noopener noreferrer"
                className="hover:text-blue-400 transition">
                <Github className="h-6 w-6" />
              </a>
              <a href="https://www.linkedin.com/in/anisha-ray-3a306a299/" target="_blank" rel="noopener noreferrer"
                className="hover:text-blue-400 transition">
        ...
        <div className="border-t border-gray-800 mt-5 pt-3 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="flex items-center text-sm text-gray-400 mt-4 md:mt-0">
            Made with <Heart className="h-4 w-4 mx-1 text-red-500" /> by Anisha
          </p>
        </div>
      </div>
    </footer>
