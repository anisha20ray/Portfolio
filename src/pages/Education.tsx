...
const Education = () => {
  const achievements = [
    {
      descr: "Got certificate in MUN organised by Nit Patna",
      year: "2023",
    },
    {
      descr: "Member of Sankalp(Sankalp Har Ghar Siksha Ka), NITP",
      // year: "2024",
    },
    {
      descr: "Scholar of #IAmFutureReady,Infosys",
      year: "2025",
    },
   
    {
      descr: "Member Of NSS, NITP",
  ...
  const education = [
    ...
    },
    {
      ...
      institution: "Shakti Shanti Academy",
      duration: "2020",
    }
  ];
